...
const FeaturedProperties = ({ properties, setSelectedProperty }) => {
  return (
    <section id='properties' className='max-w-7xl mx-auto py-16 px-4'>
        ...
        {properties.map((property) => (
          ...
          >
            <div className="relative">
              <img src={property.image?.filename} alt={property.title} className='w-full h-72 object-cover group-hover:scale-105 transition-transform duration-300 '/>
            </div>
